...
export function ItineraryMaker() {
  ...
  return <main>
    ...
    <FaqSection />
    <footer><nav aria-label="Footer navigation"><a href="#top">Trip Itinerary Maker</a><span className="footer-link-arrow" aria-hidden="true">▸</span><span> | </span><a href="#template-section">Trip Planning Templates</a><span className="footer-link-arrow" aria-hidden="true">▸</span><span> | </span><a href="/travel-planner-templates/">Travel Planner Templates</a><span className="footer-link-arrow" aria-hidden="true">▸</span></nav><a className="toolhunter-badge" href="https://toolhunter.ai/ai-tool/trip-itinerary-maker?ref=badge" target="_blank" rel="noopener"><img src="https://toolhunter.ai/badge/trip-itinerary-maker.svg?theme=light" alt="Featured on Toolhunter" width="200" height="50" /></a><p className="footer-copyright">© 2026 Trip Itinerary Maker</p></footer>
