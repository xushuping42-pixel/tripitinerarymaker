...
export default function TravelPlannerTemplatesPage() {
  return <>
    ...
    <footer><nav aria-label="Footer navigation"><Link href="/#top">Trip Itinerary Maker</Link><span className="footer-link-arrow" aria-hidden="true">▸</span><span> | </span><Link href="/#template-section">Trip Planning Templates</Link><span className="footer-link-arrow" aria-hidden="true">▸</span><span> | </span><Link href="/travel-planner-templates/">Travel Planner Templates</Link><span className="footer-link-arrow" aria-hidden="true">▸</span></nav></footer>
  </>;
}
